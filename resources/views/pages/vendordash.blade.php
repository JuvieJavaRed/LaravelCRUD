        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="/localhost:81/booking/public/dashboard">
                        <!-- Logo icon -->
                        <b>
                           Jeyam Trips
                        </b>
                 ...
                 <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            <a href="/booking/public/vendors/create" style="float:right" class="btn pull-right hidden-sm-down btn-success">Add Vendor</a>
                                <h4 class="card-title">Vendor Data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                                ...
                                                <td>{{$vendor->city}}</td>
                                                <td>{{$vendor->taluk}}</td>
                                                <td>{{$vendor->numofvehicles}}</td>
                                                <td>{{$vendor->numofmodels}}</td>
                                                <td>{{$vendor->mobilenum}}</td>
