                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @if(count($modelvarients)>0)
                                        @foreach($modelvarients as $modelvarient)
                                        <tr>
                                                <td>{{$modelvarient->vendorname}}</td>
                                                <td>{{$modelvarient->city}}</td>
                                                <td>{{$modelvarients->taluk}}</td>
                                                <td>{{$modelvarients->numofvehicles}}</td>
                                                <td>{{$modelvarients->numofmodels}}</td>
