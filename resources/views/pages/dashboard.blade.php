                ...
                <!-- Validation wizard -->
                 <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                            <a href="/localhost:81/booking/public" style="float:right" class="btn pull-right hidden-sm-down btn-success">Add Vendor</a>
                                <h4 class="card-title">Vendor Register</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Number of Vehicle Models</th>
                                                <th>Value</th>
                                            </tr>
                                        </thead>
                                        <tbody>
