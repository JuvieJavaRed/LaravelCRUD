                ...
                <!-- Validation wizard -->
                 <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                            <a href="/booking/public/enquirys/create" style="float:right" class="btn pull-right hidden-sm-down btn-success">Add Enquiry</a>
                                <h4 class="card-title">Tour Data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                                <td>{{$enquiry->enqid}}</td>
                                                <td>{{$enquiry->cxname}}</td>
                                                <td>{{$enquiry->vehicle}}</td>
                                                <td>{{$enquiry->startcity}}</td>
                                                <td>{{$enquiry->endcity}}</td>
                                                <td>{{$enquiry->whatsappnum}}</td>
                                                <td>{{$enquiry->noofpax}}</td>
                                        </tr>
                                        @endforeach
                                        @else
                                        @endif
