                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Model Register</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                                <td>{{$modelvarient->modelname}}</td>
                                                <td>{{$modelvarient->acinfo}}</td>
                                                <td>{{$modelvarient->seats}}</td>
                                                <td>{{$modelvarient->pushback}}</td>
                                                <td>{{$modelvarient->totalnos}}</td>
                                                <td>{{$modelvarient->company}}</td>
                                            </tr>
                                        @endforeach
                                        @else
                                        @endif
