...
<body>
    ...
    <script src="{{url('assets/plugins/bootstrap/js/popper.min.js')}}" type="text/javascript"></script>
    <script src="{{url('assets/plugins/bootstrap/js/bootstrap.min.js')}}" type="text/javascript"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{ url('js/jquery.slimscroll.js')}}" type="text/javascript"></script>
    <!--Wave Effects -->
    <script src="{{url('js/waves.js')}}" type="text/javascript"> </script>
    <!--Menu sidebar -->
    <script src="{{url('js/sidebarmenu.js')}}" type="text/javascript"></script>
    <!--stickey kit -->
    <script src="{{url('assets/plugins/sticky-kit-master/dist/sticky-kit.min.js')}}" type="text/javascript"></script>
    <!--Custom JavaScript -->
    <script src="{{url('js/custom.min.js')}}" type="text/javascript"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="{{url('assets/plugins/styleswitcher/jQuery.style.switcher.js')}}" type="text/javascript"></script>
</body>
